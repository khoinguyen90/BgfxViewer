...
//    default:
//        MV_ASSERT(!"gp3d texture format unknown.");
...
//
//    default:
//        MV_ASSERT(!"bimg texture format not supported.");
...
//    if (data == NULL)
//    {
//        MV_ERROR("Failed to read image from file '%s'.", filePath);
...
//    {
//        MV_ERROR("Failed to parse image data from file '%s'.", filePath);
//        return BGFX_INVALID_HANDLE;
//    }
//
//    // create bgfx texture
//    bgfx::TextureHandle handle = createTexture(imageContainer, flags, info);
//    MV_ASSERT(bgfx::isValid(handle));
//
//    // free file data
//    delete[] data;
//
